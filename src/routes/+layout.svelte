<script>
  ...
  let hidden = true;
  const toggleDrawer = () => (hidden = false);
...
<div class="sticky top-0 z-50">
  <Button outline size="xs" color="none" on:click={toggleDrawer}>
    <svg
  ...
  <Drawer transitionType="fly" {transitionParams} bind:hidden id="sidebar2">
    ...
    <Sidebar>
      <SidebarWrapper>
        <SidebarGroup>
          <!-- Gallery -->
          <SidebarItem label="Gallery" href="/" active={activeUrl === "/"} />
          <!-- Database -->
          <SidebarItem
            label="Database"
            {spanClass}
            href="/database"
            active={activeUrl === "/database"}
          />
        </SidebarGroup>
      </SidebarWrapper>
    </Sidebar>
...
<!--       <FooterBrand -->
<!--         href="/" -->
<!--         src="https://cdnfile.aixifan.com/static/umeditor/emotion/images/ac/35.gif" -->
<!--         alt="Lost logo" -->
<!--         name="LOST" -->
<!--       /> -->
<!--     </div> -->
...
<!--           <FooterLink liClass="mb-4" href="/">SvelteKit</FooterLink> -->
<!--         </FooterLinkGroup> -->
<!--       </div> -->
<!--       <div> -->
<!--         <h2 -->
